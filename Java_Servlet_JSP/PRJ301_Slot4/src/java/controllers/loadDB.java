...
"                  <input type='checkbox' name='gender' value='M' "+
                    ...
                    +">Male/Female &nbsp;\n"+
"                  </td>\n"+
                    //chuyển gender radiobox thành check box
//"            </tr>\n" +
                    //cách 1 dùng select option
//"            <tr>\n" +
//"                <td>Department</td>\n" +
...
"                    <legend>Department</legend>";
                    for(Map.Entry<String, Department> en : d.getDept().entrySet()){
                        String key = en.getKey();
                        Department val = en.getValue();
                        form+= "<input type='radio' name='departId' id='dept"+val.getId()+"' "+
                                (stUpdate==null?"":(stUpdate.getDepartId().equals(key)?"checked":""))
                                +" value='"+val.getId()+"'>";
                        form+="<label for='dept"+val.getId()+"'>"+val.getName()+"</label> <br>";
                    }
                    form += "</fieldset></td>\n" +
"            </tr>\n"+  
"            <tr>\n" +
...
"    </form>";
    ...
    throws ServletException, IOException {
        ...
        Object o3 = request.getParameter("btnChange");
