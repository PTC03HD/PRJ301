    ...
    <div class="page-holder">
          ...
          <nav class="navbar navbar-expand-lg navbar-light py-3 px-lg-0"><a class="navbar-brand" href="loadDB?page=index"><span class="fw-bold text-uppercase text-dark">Boutique</span></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              ...
              <ul class="navbar-nav ms-auto">               
                ...
                <li class="nav-item">
                    <a class="nav-link" href="loadDB?page=login">
      ...
      <div class="container">
        ...
        <section class="pt-5">
          ...
          <div class="row">
            <div class="col-md-4">
                <a class="category-item" href="loadDB?page=index"><img class="img-fluid" src="img/cat-img-1.jpg" alt=""/><strong class="category-item-title">Clothes</strong></a>
            </div>
            <div class="col-md-4">
                <a class="category-item mb-4" href="loadDB?page=index"><img class="img-fluid" src="img/cat-img-2.jpg" alt=""/><strong class="category-item-title">Shoes</strong></a>
                <a class="category-item" href="loadDB?page=index"><img class="img-fluid" src="img/cat-img-3.jpg" alt=""/><strong class="category-item-title">Watches</strong></a>
            </div>
            <div class="col-md-4">
                <a class="category-item" href="loadDB?page=shop"><img class="img-fluid" src="img/cat-img-4.jpg" alt=""/><strong class="category-item-title">Electronics</strong></a>
            </div>
          </div>
        </section>
        <!-- TRENDING PRODUCTS-->
