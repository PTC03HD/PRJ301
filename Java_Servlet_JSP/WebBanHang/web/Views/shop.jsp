                    ...
                    <nav class="navbar navbar-expand-lg navbar-light py-3 px-lg-0"><a class="navbar-brand" href="loadDB?page=index"><span class="fw-bold text-uppercase text-dark">Boutique</span></a>
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav me-auto">
                                ...
                                <li class="nav-item">
                                    <!-- Link--><a class="nav-link active" href="loadDB?page=shop">Shop</a>
                                </li>
                                <li class="nav-item">
                            ...
                            <div class="col-lg-3 order-2 order-lg-1">
                                ...
                                <ul class="list-unstyled small text-muted ps-lg-4 font-weight-normal">
                                    <c:forEach items="${dao.c}" var="cate">
                                        <li class="mb-2"><a class="reset-anchor" href="#!">${cate.name}</a></li>
                                    </c:forEach>
                                </ul>
                            ...
                            <div class="col-lg-9 order-1 order-lg-2 mb-5 mb-lg-0">
                                    ...
                                    <c:forEach items="${dao.pagingPro}" var="pro">
                                        ...
                                        <div class="col-lg-4 col-sm-6">
                                            <div class="product text-center">
                                                ...
                                                <h6> <a class="reset-anchor" href="loadDB?page=detail">${pro.name}</a></h6>
                                ...
                                <nav aria-label="Page navigation example">
                                    <ul class="pagination justify-content-center justify-content-lg-end">
                                        <li class="page-item mx-1"><a class="page-link" href="paging?index=1" aria-label="Home"><span aria-hidden="true">«</span></a></li>
                                        <li class="page-item mx-1"><a class="page-link" href="paging?index=${index>1?index-1:index}" aria-label="Previous"><span aria-hidden="true">‹</span></a></li>
                                        <c:forEach begin="1" end="${endP}" var="i">
                                        <li class="page-item mx-1 ${index==i?"active":""}"><a  class="page-link" href="paging?index=${i}">${i}</a></li>
                                        </c:forEach>
                                        <li class="page-item ms-1"><a class="page-link" href="paging?index=${index<endP?index+1:index}" aria-label="Next"><span aria-hidden="true">›</span></a></li>
                                        <li class="page-item ms-1"><a class="page-link" href="paging?index=${endP}" aria-label="End"><span aria-hidden="true">»</span></a></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
